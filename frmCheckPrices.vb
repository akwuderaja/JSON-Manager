...
Public Class frmCheckPrices
                ...
                If fileContents(i).Contains(searchStringFurniId) Then
                    ...
                    Else
                        ...
                        If snapshot IsNot Nothing Then
                            ...
                            Dim cheapestPriceDifference As Integer = snapshot.cheapestPrice -
                                ((nudValue.Value / 100) * snapshot.cheapestPrice)
                            ...
                            If fileContents.Length >= i + 3 Then
                                ...
                                Next
                            End If
                            If cheapestPriceDifference <= sellPrice Then
    ...
    Private Sub btnProcess_ClickOld(sender As Object, e As EventArgs)
        Try
            ...
            For Each file In IO.Directory.GetFiles(txtFurnIdJson.Text)
                Dim fileContentsFurnId As String = My.Computer.FileSystem.ReadAllText(file)
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If IndividualDifferencesString.Length > 0 Then
                sfd.Title = "Save individualdifference.json"
                sfd.FileName = "individualdifference.json"
